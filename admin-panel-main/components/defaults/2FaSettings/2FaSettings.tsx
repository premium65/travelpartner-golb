...
const FaSettings = () => {
  ...
  return (
    <div className="my-10">
      <div className="relative z-10 overflow-hidden bg-indigo-600 py-16 px-8 mt-20">
        ...
        <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
                <div className="text-center lg:text-left ">
                    ...
                    <h1
                            className="mt-0 mb-3 text-2xl font-bold leading-tight sm:leading-tight md:leading-tight text-yellow-500 ">
                          Status</h1>
                        <h3
                            className="mt-0 mb-3 text-xl font-semibold leading-tight sm:leading-tight md:leading-tight text-white ">
                           You've currently disabled Two factor authentication</h3>
                        <p
